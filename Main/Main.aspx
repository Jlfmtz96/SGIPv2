...
<div class="container-fluid">
    <div class="relative" style="text-align: -webkit-center; background-color: rgb(241 245 249);">
        ...
        <asp:Label ID="lblBienvenida" runat="server" Text="" CssClass="h1 absolute text-8xl text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-sm xl:text-8xl lg:text-6xl sm:text-3xl" style="font-weight: 600;"></asp:Label>
        <h2 class="absolute text-3xl text-white bottom-4 left-1/2 -translate-x-1/2 text-sm sm:text-lg"  style="font-weight: 600;">Sistema de Indicadores de Posgrado</h2>
    </div>
</div>
</asp:Content>
