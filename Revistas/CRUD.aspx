<%@ Page Title="" Language="C#" MasterPageFile="~/MP.Master" AutoEventWireup="true" CodeBehind="CRUD.aspx.cs" Inherits="SGIPv2.Revistas.WebForm1" %>
        ...
        <div class="space-y-12">
            <div class="grid grid-cols-1 gap-x-6 gap-y-8">
                <div class="col-span-full">
                  <label class="block text-sm font-medium leading-6 text-gray-900">Clave ISBN*</label>
                  <div class="mt-2">
                    <asp:TextBox runat="server" Enabled="false" CssClass="block w-full rounded-md border-0 px-1.5 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" ID="tbclave" style="width: 350px;" placeholder="Clave" MaxLength="20"></asp:TextBox>
                  </div>
                </div>
                ...
                <div class="col-span-full">
                  <label class="block text-sm font-medium leading-6 text-gray-900">País*</label>
                  <div class="mt-2">
                    <asp:TextBox runat="server" CssClass="block w-full rounded-md border-0 px-1.5 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" ID="tbpais" style="width: 350px;" onkeypress="return soloLetras(event);" placeholder="País" MaxLength="50"></asp:TextBox>
                  </div>
                </div>
                ...
                <div class="col-span-full">
                    ...
                    <div class="mt-2">
                        <asp:TextBox runat="server" CssClass="block w-full rounded-md border-0 px-1.5 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" ID="tbdoi" style="width: 350px;" placeholder="DOI"></asp:TextBox>
                    </div>
                </div>
