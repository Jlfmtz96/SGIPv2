<%@ Page Title="" Language="C#" MasterPageFile="~/MP.Master" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="SGIPv2.Proyectos.Index" %>
    ...
    <div class="container mx-auto">
        <div class="flex justify-end">
            ...
            <div class="dropdown text-sm font-medium" style="position: relative; margin-right: auto; background-color:rgb(0 74 152); border-radius:10px; padding:10px; color:white">
                ...
                <div class="dropdown-menu" aria-labelledby="btnDropdown" style="position: absolute; top: 100%; left: 0;  background-color:rgb(0 74 152); border-radius:10px;">
                    <div class="dropdown-item" style=" padding: 8px;">
                        <asp:CheckBox ID="chkColumn1" runat="server" Text="Clave" Checked="true" />
                    </div>
                    <div class="dropdown-item" style=" padding: 8px;">
                        <asp:CheckBox ID="chkColumn2" runat="server" Text="Título" Checked="true" />
                    </div>
                     <div class="dropdown-item" style=" padding: 8px;">
                         <asp:CheckBox ID="chkColumn3" runat="server" Text="Protocolo" Checked="true" />
                    </div>
                    <div class="dropdown-item" style=" padding: 8px;">
                        <asp:CheckBox ID="chkColumn4" runat="server" Text="Alcance" Checked="true" />
                    </div>
                     <div class="dropdown-item" style=" padding: 8px;">
                         <asp:CheckBox ID="chkColumn5" runat="server" Text="Área" Checked="true" />
                     </div>
                     <div class="dropdown-item" style=" padding: 8px;">
                         <asp:CheckBox ID="chkColumn6" runat="server" Text="Fecha de inicio" Checked="true" />
                     </div>
                    <div class="dropdown-item" style=" padding: 8px;">
                          <asp:CheckBox ID="chkColumn7" runat="server" Text="Fecha de fin" Checked="true" />
                    </div>
                     <div class="dropdown-item" style=" padding: 8px;">
                           <asp:CheckBox ID="chkColumn8" runat="server" Text="Registro de ética" Checked="true" />
                     </div> 
                    <div class="dropdown-item" style=" padding: 8px;">
                           <asp:CheckBox ID="chkColumn9" runat="server" Text="Lugar de registro" Checked="true" />
                     </div>
                     <div class="dropdown-item" style=" padding: 8px;">
                           <asp:CheckBox ID="chkColumn10" runat="server" Text="Cuerpo académico" Checked="true" />
                     </div>
                    <div class="dropdown-item" style=" padding: 8px;">
                          <asp:CheckBox ID="chkColumn11" runat="server" Text="Financiamiento" Checked="true" />
                    </div>
                     <div class="dropdown-item" style=" padding: 8px;">
                           <asp:CheckBox ID="chkColumn12" runat="server" Text="Grado del posgrado" Checked="true" />
                     </div>
                    <div class="dropdown-item" style=" padding: 8px;">
                          <asp:CheckBox ID="chkColumn13" runat="server" Text="Comentarios" Checked="true" />
                    </div>
                   
                    <div class="dropdown-item" style=" padding: 8px;">
                          <asp:CheckBox ID="CheckBox14" runat="server" Text="Profesor responsable" Checked="true" />
                    </div>  
                    <div class="dropdown-item" style=" padding: 8px;">
                          <asp:CheckBox ID="CheckBox15" runat="server" Text="Alumno(s) participantes" Checked="true" />
                    </div>
            ...
            <div style="align-items: center;">
                <asp:TextBox ID="txtBusqueda" runat="server" style="border: 1px solid #CCCCCC; border-radius: 4px; padding: 6px 10px;" CssClass="form-control"></asp:TextBox>
